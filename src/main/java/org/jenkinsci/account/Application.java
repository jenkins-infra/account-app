...
public class Application {
    ...
    public static final String SPAM_MESSAGE = "The anti-spam system was triggered: we need your help to prove that you are human and not a robot (or a human spammer). " +
        "Open an issue on <a href='https://github.com/jenkins-infra/helpdesk/issues'>https://github.com/jenkins-infra/helpdesk</a> and provide the email and the userid you tried to register with, as well as the version of Jenkins you currently are running. " +
        "Try to make your email look legitimate and not like it's written by someone who doesn't know anything or just read the jenkins.io home page. " +
